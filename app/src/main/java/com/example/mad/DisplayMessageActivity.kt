...
//        val textView3 =
            findViewById<TextView>(R.id.textView31).apply {
            text = message3
        }

        val message4 = intent.getStringExtra("advX")
//        val textView4 =
            findViewById<TextView>(R.id.textView33).apply {
            text = message4
        }
...
//        val textView8 =
            findViewById<TextView>(R.id.textView21).apply {
            text = message8
        }

        val message9 = intent.getStringExtra("Noun5X")
//        val textView9 =
            findViewById<TextView>(R.id.textView27).apply {
            text = message9
        }
...
//        val textView11 =
            findViewById<TextView>(R.id.textView39).apply {
            text = message11
        }
    }
